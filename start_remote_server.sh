...
export MCP_SSH_CONFIG_FILE=${MCP_SSH_CONFIG_FILE:-"config/remote_config.json"}

# 检查配置文件
if [ ! -f "$MCP_SSH_CONFIG_FILE" ]; then
    echo "警告: 配置文件 $MCP_SSH_CONFIG_FILE 不存在"
    echo "使用默认配置"
fi
